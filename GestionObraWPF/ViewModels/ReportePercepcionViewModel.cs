...
{
    public class ReportePercepcionViewModel : BindableBase
    {
        ...
        public ReportePercepcionViewModel()
        {
        ...
        private void Calcular()
        {
            ...
            IvaCompra = 0;
            IvaVenta = 0;
            foreach (var item in Presupuestos.Where(x => x.Percepciones != 0))
            {
